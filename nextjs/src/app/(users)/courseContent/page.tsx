...
import { Content_Details } from '@/app/store/slice/userSlice';
            ...
            <div className='bg-cover bg-no-repeat bg-center ' style={{backgroundImage: 'url(/images/BgImages.png)'}} >
                    <div className='max-w-7xl container  md:mx-auto lg:px-8 overflow-hidden  '>
                            <div className='py-10 px-3'>                            
                                ...
                                <div className='my-9'>
                                <button className='text-white text-[16px] w-[177px] p-3 border border-blue-600 bg-blue-600 rounded-full' onClick={handleAdd}>Add Course</button>
                              </div>                         
                            </div>                           
                    </div>
            </div>
